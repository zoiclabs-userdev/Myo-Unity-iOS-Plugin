...
/** Posted when a Myo armband recognizes that it is on an arm.

   kTLMKeyArmRecognizedEvent -> TLMArmRecognizedEvent
 */
extern NSString *const TLMMyoDidReceiveArmRecognizedEventNotification;

/** Posted when a Myo armband is moved or removed from the arm.

   kTLMKeyArmLostEvent -> TLMArmLostEvent
 */
extern NSString *const TLMMyoDidReceiveArmLostEventNotification;
...
/**
   NSNotification userInfo key for a TLMArmRecognizedEvent object.
 */
extern NSString *const kTLMKeyArmRecognizedEvent;

/**
   NSNotification userInfo key for a TLMArmLostEvent object.
 */
extern NSString *const kTLMKeyArmLostEvent;
